...
uniform World world;
uniform Lambertian lambertianMaterials[OBJECT_COUNT];
uniform HalfLambertian halfLambertianMaterials[OBJECT_COUNT];
uniform Metallic metallicMaterials[OBJECT_COUNT];
uniform Dielectric dielectricMaterials[OBJECT_COUNT];
