...
inline bool operator==(const Format &fmt1, Format::_Format fmt2)
{
    return fmt1.GetHandle() == fmt2;
}
inline bool operator==(Format::_Format fmt1, const Format &fmt2)
{
    return fmt2 == fmt1;
}
inline bool operator==(const Format &fmt1, const Format &fmt2)
{
    return fmt1.GetHandle() == fmt2.GetHandle();
}
inline bool operator==(VkFormat fmt1, const Format &fmt2)
{
    return (Format::_Format)fmt1 == fmt2.GetHandle();
}
inline bool operator==(const Format &fmt1, VkFormat fmt2)
{
    return fmt2 == fmt1;
}
inline bool operator==(VkFormat fmt1, const Format::_Format &fmt2)
{
    return (Format::_Format)fmt1 == fmt2;
}
inline bool operator==(const Format::_Format &fmt1, VkFormat fmt2)
{
    return fmt2 == fmt1;
}
